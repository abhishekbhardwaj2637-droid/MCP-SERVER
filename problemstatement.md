...
1. **Ingest** public reviews from the last 8–12 weeks (configurable window) from Google Play Store (scraper-based).
...
*Note: The agent is an MCP host/client; it does not embed Google credentials or call the Docs/Gmail REST APIs directly for delivery.*
